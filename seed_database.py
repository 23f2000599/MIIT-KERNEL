...
def seed_database():
    with app.app_context():
        ...
        # Create sample TA users and profiles
        tas_data = [
            {
                'name': 'Sarah Chen',
            ...
            },
            {
                ...
                'bio': '⚗️ Chemical Engineering graduate | Love helping students understand STEM concepts | Fun and interactive sessions',
                'rating': 4.7,
                'total_hours': 85,
            ...
            },
            {
                ...
                'bio': '🏛️ History PhD student | Research methodology expert | Helps with papers, citations, and critical thinking',
                'rating': 4.5,
                'total_hours': 55,
        ...
        db.session.commit()
        print(f"Successfully created {len(tas_data)} TA profiles!")
